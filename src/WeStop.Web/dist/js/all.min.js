...
angular.module("WeStop",["ngRoute","ngMessages","ngAnimate","angular-uuid","ngMaterial","md.data.table"]).value("API_SETTINGS",{uri:"http://localhost:5000"}).config(["$routeProvider","$locationProvider","$mdThemingProvider","$httpProvider","$mdGestureProvider","$mdAriaProvider",function(e,t,n,a,o,r){a.interceptors.push("httpInterceptor"),t.hashPrefix(""),o.skipClickHijack(),n.theme("default").dark(),n.theme("default").primaryPalette("blue").accentPalette("teal").warnPalette("red"),r.disableWarnings(),e.when("/",{controller:"createUserController",templateUrl:"views/user/create.html",secure:!1}).when("/lobby",{controller:"lobbyController",templateUrl:"views/lobby.html",secure:!0}).when("/game/create",{controller:"createGameController",templateUrl:"views/game/create.html",secure:!0}).when("/game/:id",{controller:"gameController",templateUrl:"views/game/game.html",secure:!0}).otherwise({redirectTo:"/"})}]).run(["$user","$rootScope","$location","$window",(e,t,n,a)=>{t.user=e.get(),t.$on("$routeChangeStart",(e,a,o)=>{a.$$route.secure&&!t.user?n.path("/"):!a.$$route.secure&&t.user&&n.path("/lobby")}),a.fbAsyncInit=function(){FB.init({appId:"659220371267596",status:!0,cookie:!0,xfbml:!0,version:"v2.6"})},"serviceWorker"in navigator&&navigator.serviceWorker.register("./service-worker.js").then(function(e){},function(e){console.log("ServiceWorker registration failed: ",e)})}]),angular.module("WeStop").controller("createGameController",["$game","$scope","$location","$rootScope","$http","API_SETTINGS",function(e,t,n,a,o,r){let i=[];function l(e){t.game.gameOptions.themes=[];for(let n=0;n<e;n++){let e=i.filter(e=>!t.game.gameOptions.themes.includes(e)),n=e[Math.floor(Math.random()*e.length)];t.game.gameOptions.themes.push(n)}}o.get(r.uri+"/api/themes.list").then(e=>{e.data.themes.forEach(e=>{i.push(e.name)}),l(6)}),t.drawnAnotherThemes=function(){l(6)},t.themeToAdd={},t.letters=[{value:"A",enabled:!0},{value:"B",enabled:!0},{value:"C",enabled:!0},{value:"D",enabled:!0},{value:"E",enabled:!0},{value:"F",enabled:!0},{value:"G",enabled:!0},{value:"H",enabled:!1},{value:"I",enabled:!0},{value:"J",enabled:!0},{value:"K",enabled:!1},{value:"L",enabled:!0},{value:"M",enabled:!0},{value:"N",enabled:!0},{value:"O",enabled:!0},{value:"P",enabled:!0},{value:"Q",enabled:!1},{value:"R",enabled:!0},{value:"S",enabled:!0},{value:"T",enabled:!0},{value:"U",enabled:!1},{value:"V",enabled:!0},{value:"W",enabled:!1},{value:"X",enabled:!1},{value:"Y",enabled:!1},{value:"Z",enabled:!1}],t.game={user:a.user,gameOptions:{themes:[],availableLetters:[],rounds:"4",numberOfPlayers:"6",roundTime:"30"}},t.addTheme=(e=>{i.includes(e)||i.push(e),t.game.gameOptions.availableThemes.includes(e)}),t.confirm=function(){t.game.gameOptions.availableLetters=function(){let e=[];return t.letters.forEach(t=>{t.enabled&&e.push(t.value)}),e}(),o.post(r.uri+"/api/games.create",t.game).then(e=>{n.path("/game/"+e.data.id)})},t.goToLobby=(()=>{n.path("/lobby")})}]),angular.module("WeStop").controller("createUserController",["$scope","uuid","$user","$location","facebookService","googleService","twitterService",function(e,t,n,a,o,r,i){function l(e,o){n.create({id:t.v4(),userName:e,imageUri:o}),a.path("/lobby")}e.user={name:"",image:"/images/default-user.jpg"},e.createUser=(()=>{l(e.user.name,e.user.image)}),e.createWithFacebook=(()=>{o.connect().then(function(t){o.me("first_name").then(function(t){e.user.name=t.first_name,o.getProfilePic(t.id).then(function(t){e.user.image=t,l(e.user.name,e.user.image)})},function(e){console.log(e)})})}),e.createWithGoogle=(()=>{r.getUserNameAndProfilePic().then(e=>{l(e.userName,e.imageUri)},function(e){console.log(e)})}),e.createWithTwitter=(()=>{i.getUserNameAndProfilePic().then(function(e){l(e.userName,e.imageUri)},function(e){console.log(e)})})}]),angular.module("WeStop").controller("gameController",["$routeParams","$scope","$game","$rootScope","$mdToast","$location",function(e,t,n,a,o,r){function i(){t.allPlayersReady=!1,t.roundStarted=!1,t.roundStopped=!1,t.gameFinished=!1,t.validationStarted=!1,t.validationTimeOver=!1,t.sortedLetter="?",t.answersTime=0,t.currentAnswersTimePercentage=0,t.currentValidationTime=0,t.currentValidationTimePercentage=0,t.themeValidations=null}function l(e){t.game=e,t.game.players.sort(function(e,t){return e.id==a.user.id?-1:t.id==a.user.id?1:0})}function s(e){t.player=e}function u(){t.allPlayersReady=!0,t.roundStarted=!0,t.roundStopped=!1,t.gameFinished=!1,t.validationStarted=!1,t.validationTimeOver=!1,t.answers=[];for(let e=0;e<t.game.themes.length;e++)t.answers.push({theme:t.game.themes[e],answer:""})}function d(){t.allPlayersReady=!0,t.roundStarted=!0,t.roundStopped=!0,t.gameFinished=!1,t.validationStarted=!0,t.validationTimeOver=!1,t.currentValidationTime=0}function c(){t.allPlayersReady=!1,t.roundStarted=!1,t.roundStopped=!1,t.gameFinished=!0,t.validationStarted=!1,t.validationTimeOver=!0}function m(e){let n=t.scoreboard.find(t=>t.playerId===e);return n?n.gamePontuation:0}function p(){1!==t.game.players.length?t.allPlayersReady=!t.game.players.some(e=>e.id!==t.player.id&&!e.isReady):t.allPlayersReady=!1}function g(){t.currentValidation=null}function f(){for(let e=0;e<t.game.players.length;e++){let n=t.game.players[e];n.totalPontuation=m(n.id)}}function h(e){t.winners=e}function v(e){t.sortedLetter=e}function b(e){t.scoreboard=e}function y(e){return t.game.players.find(t=>t.id===e)}function S(){t.game.currentRoundNumber+=1}function _(e,t){return 100*t/e}function w(e){e.validations&&0!==e.validations.length&&(t.currentValidationTimePercentage=0,t.currentValidation={number:e.validationsNumber,total:e.totalValidations,theme:e.theme,validations:e.validations})}function P(){return{gameId:e.id,playerId:a.user.id,roundNumber:t.game.currentRoundNumber,theme:t.currentValidation.theme,validations:t.currentValidation.validations}}function $(e){return t.game.players.indexOf(e)}n.on("im_joined_game",e=>{l(e.game),s(e.player),S(),b(e.lastRoundScoreboard),p()}),n.on("im_reconected_game",e=>{switch(l(e.game),s(e.player),e.game.state){case"InProgress":v(e.round.sortedLetter),u();break;case"Validations":v(e.round.sortedLetter),e.validated?g():(w(e),d());break;case"Finished":h(e.winners),b(e.lastRoundScoreboard),c(),f()}}),t.startRound=(()=>{t.changeStatus(),n.invoke("start_round",e.id)}),n.on("round_started",e=>{v(e.sortedLetter);let n=t.game.availableLetters.indexOf(e.sortedLetter);t.game.availableLetters.splice(n,1),t.game.sortedLetters.push(e.sortedLetter),u()}),n.on("player_joined_game",e=>{t.game.players.find(t=>t.id===e.player.id)||(t.game.players.push(e.player),o.show(o.simple().textContent(e.player.userName+" entrou na partida").position("bottom left").hideDelay(1500))),p()}),t.changeStatus=(()=>{n.invoke("player_change_status",e.id,a.user.id,!t.player.isReady)}),n.on("im_change_status",e=>{let n=y(t.player.id);t.player.isReady=n.isReady=e.isReady}),n.on("player_changed_status",e=>{y(e.id).isReady=e.isReady,p()}),t.stop=(()=>{n.invoke("stop_round",e.id,a.user.id)}),n.on("round_stoped",r=>{if("player_call_stop"===r.reason&&r.playerId!==t.player.id){let e=y(r.playerId);o.show(o.simple().textContent(e.userName+" chamou STOP!").position("bottom left").hideDelay(3500))}t.roundStopped=!0,t.roundTime=0,n.invoke("send_answers",{playerId:a.user.id,gameId:e.id,roundNumber:t.game.currentRoundNumber,answers:t.answers})}),n.on("im_send_validations",e=>{g()}),n.on("round_finished",e=>{i(),b(e.scoreboard),f(),S(),g(),t.changeStatus()}),n.on("game_finished",e=>{i(),c(),b(e.lastRoundScoreboard),h(e.winners),f()}),t.roundPontuations=[],n.on("receive_my_pontuations_in_round",e=>{t.roundPontuations.push(e)}),n.on("round_time_elapsed",e=>{t.currentAnswersTimePercentage=_(t.game.time,e),function(e){t.currentAnswersTime=e}(e)}),n.on("validation_started",e=>{w(e),d()}),n.on("validation_time_elapsed",e=>{t.currentValidationTimePercentage=_(10,e.currentTime),function(e){t.currentValidationTime=e}(e.currentTime)}),n.on("validation_time_over",()=>{t.validationTimeOver=!0,function(){let e=P();n.invoke("send_validations_after_time_over",e)}()}),t.finishValidation=function(){let e=P();n.invoke("send_validations",e)},n.on("player_left",e=>{let n=y(e);n&&(!function(e){let n=$(e);n>-1&&t.game.players.splice(n,1)}(n),n.id!==t.player.id&&o.show(o.simple().textContent(n.userName+" deixou a partida").position("bottom left").hideDelay(1500)))}),n.on("new_admin_setted",e=>{!function(e){let n=$(e);n>-1&&(t.game.players[n].isAdmin=!0,e.id===t.player.id&&(t.player.isAdmin=!0,o.show(o.simple().textContent("Você é o administrador da partida").position("bottom left").hideDelay(2500))))}(y(e))}),t.leave=(()=>{t.gameFinished?t.goToLobby():(a.isLoading=!0,n.invoke("leave",e.id,a.user.id).then(function(){a.isLoading=!1,t.goToLobby()},()=>a.isLoading=!1))}),t.goToLobby=(()=>{n.leave(),r.path("/lobby")}),i(),n.invoke("join",e.id,"",a.user)}]),angular.module("WeStop").controller("lobbyController",["$scope","$location","$http","API_SETTINGS",function(e,t,n,a){n.get(a.uri+"/api/games.list").then(t=>{e.games=t.data.games},e=>{console.error(e)}),e.gameDetails=null,e.showGameDetails=!1,e.details=function(t){e.gameDetails=t,e.showGameDetails=!0},e.backToGames=function(){e.gameDetails=null,e.showGameDetails=!1},e.joinGame=(()=>t.path("/game/"+e.gameDetails.id)),e.newGame=(()=>t.path("/game/create"))}]),angular.module("WeStop").controller("mainController",["$scope","$location","$user",function(e,t,n){e.logout=function(){n.logout(()=>t.path("/"))}}]),angular.module("WeStop").factory("httpInterceptor",["$rootScope","$q",function(e,t){var n=0;return{request:function(t){return e.isLoading=!0,n++,t},requestError:function(a){return--n<=0&&(e.isLoading=!1),t.reject(a)},response:function(t){return--n<=0&&(e.isLoading=!1),t},responseError:function(a){return--n<=0&&(e.isLoading=!1),t.reject(a)}}}]),angular.module("WeStop").factory("facebookService",["$q",function(e){return{connect:function(){var t=e.defer();return FB.getLoginStatus(function(e){"connected"!==e.status?FB.login(function(e){"connected"===e.status?t.resolve(e):t.reject(e)},{scope:"public_profile"}):t.resolve(e)}),t.promise},me:function(t){var n=e.defer();return FB.api("/me",{fields:t},function(e){!e||e.error?n.reject("Error occured"):n.resolve(e)}),n.promise},getProfilePic:function(t){var n=e.defer();return FB.api(t+"/picture?redirect=false&height=200&width=200",function(e){n.resolve(e.data.url)}),n.promise}}}]),angular.module("WeStop").factory("$game",["$rootScope","API_SETTINGS",function(e,t){let n=o();function a(){console.log("hubConnection has closed")}function o(){return(new signalR.HubConnectionBuilder).withUrl(t.uri+"/game").build()}function r(){n||(n=o())}return{onConnectionClose:a,on:function(t,a){r(),n.on(t,t=>{e.$apply(()=>{a&&a(t)})})},invoke:function(...t){return r(),n&&"Disconnected"!==n.connectionState?n.invoke(...t):(o=(()=>n.invoke(...t)),n.serverTimeoutInMilliseconds=3e4,n.onclose(function(){a()}),void n.start().then(function(){e.$apply(()=>o())},t=>{e.$apply(function(){i&&i(t)})}));var o,i},leave:function(){n&&(n.connection.stop(),n=null)}}}]),angular.module("WeStop").factory("googleService",["$q","$window",function(e,t){function n(e){let t=e.getBasicProfile();return{userName:t.getGivenName(),imageUri:t.getImageUrl()}}return{getUserNameAndProfilePic:function(){let t=e.defer();return gapi.load("auth2",function(){gapi.auth2.init({client_id:"418166283498-phlpf67p4nitc1gd79s51afl3ruqls2d.apps.googleusercontent.com",fetch_basic_profile:!0}).then(function(e){let a=e.currentUser.get();if(a&&a.isSignedIn()){let e=n(a);t.resolve(e)}else e.signIn({prompt:"select_account"}).then(function(e){let a=n(e);t.resolve(a)},function(e){t.reject(e)})})}),t.promise}}}]),angular.module("WeStop").factory("twitterService",["$q",function(e){const t={apiKey:"AIzaSyAMtxk9YGof82udlAC_LkkB4mgc-JxFmAI",authDomain:"westop-1571110414274.firebaseapp.com",databaseURL:"https://westop-1571110414274.firebaseio.com",projectId:"westop-1571110414274",storageBucket:"westop-1571110414274.appspot.com",messagingSenderId:"418166283498",appId:"1:418166283498:web:7ab90ab027f742f6b80b93"};return{getUserNameAndProfilePic:function(){firebase.apps.length||firebase.initializeApp(t);let n=new firebase.auth.TwitterAuthProvider,a=e.defer();return firebase.auth().signInWithPopup(n).then(function(e){let t=e.user;a.resolve({userName:t.displayName.split(" ")[0],imageUri:t.photoURL})}).catch(function(e){a.reject(e)}),a.promise}}}]),angular.module("WeStop").service("$user",["$rootScope",function(e){this.create=(t=>{sessionStorage.setItem("user",JSON.stringify(t)),e.user=t}),this.get=(()=>JSON.parse(sessionStorage.getItem("user"))),this.logout=(t=>{sessionStorage.removeItem("user"),e.user=null,t&&t()})}]);
