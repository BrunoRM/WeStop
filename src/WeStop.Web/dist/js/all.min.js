...
angular.module("WeStop",["ngRoute","ngMessages","ngAnimate","angular-uuid","ngMaterial","md.data.table"]).value("API_SETTINGS",{uri:"https://westopapi.azurewebsites.net"}).config(["$routeProvider","$locationProvider","$mdThemingProvider","$httpProvider","$mdGestureProvider","$mdAriaProvider",function(e,t,a,n,r,o){n.interceptors.push("httpInterceptor"),t.hashPrefix(""),r.skipClickHijack(),a.alwaysWatchTheme(!0),a.theme("light").primaryPalette("blue").accentPalette("teal").warnPalette("red").backgroundPalette("grey"),a.theme("dark").dark(),a.theme("dark").primaryPalette("blue").accentPalette("teal").warnPalette("red").dark(),a.setDefaultTheme("dark"),o.disableWarnings(),e.when("/",{controller:"createUserController",templateUrl:"views/user/create.html",secure:!1}).when("/lobby",{controller:"lobbyController",templateUrl:"views/lobby.html",secure:!0}).when("/game/create",{controller:"createGameController",templateUrl:"views/game/create.html",secure:!0}).when("/game/:id",{controller:"gameController",templateUrl:"views/game/game.html",secure:!0}).otherwise({redirectTo:"/"})}]).run(["$user","$rootScope","$location","$window",(e,t,a,n)=>{t.user=e.get(),t.$on("$routeChangeStart",(e,n,r)=>{n.$$route.secure&&!t.user?a.path("/"):!n.$$route.secure&&t.user&&a.path("/lobby")}),n.fbAsyncInit=function(){FB.init({appId:"659220371267596",status:!0,cookie:!0,xfbml:!0,version:"v2.6"})},"serviceWorker"in navigator&&navigator.serviceWorker.register("./service-worker.js").then(function(e){},function(e){console.log("ServiceWorker registration failed: ",e)})}]),angular.module("WeStop").controller("createGameController",["$scope","$location","$rootScope","$http","API_SETTINGS",function(e,t,a,n,r){let o=[];function i(t){e.game.gameOptions.themes=[];for(let a=0;a<t;a++){let t=o.filter(t=>!e.game.gameOptions.themes.includes(t)),a=t[Math.floor(Math.random()*t.length)];e.game.gameOptions.themes.push(a)}}function s(){let t=[];return e.letters.forEach(e=>{e.enabled&&t.push(e.value)}),t}n.get(r.uri+"/api/themes.list").then(e=>{e.data.themes.forEach(e=>{o.push(e.name)}),i(6)}),e.drawnAnotherThemes=function(){i(6)},e.themeToAdd={},e.letters=[{value:"A",enabled:!0},{value:"B",enabled:!0},{value:"C",enabled:!0},{value:"D",enabled:!0},{value:"E",enabled:!0},{value:"F",enabled:!0},{value:"G",enabled:!0},{value:"H",enabled:!1},{value:"I",enabled:!0},{value:"J",enabled:!0},{value:"K",enabled:!1},{value:"L",enabled:!0},{value:"M",enabled:!0},{value:"N",enabled:!0},{value:"O",enabled:!0},{value:"P",enabled:!0},{value:"Q",enabled:!1},{value:"R",enabled:!0},{value:"S",enabled:!0},{value:"T",enabled:!0},{value:"U",enabled:!1},{value:"V",enabled:!0},{value:"W",enabled:!1},{value:"X",enabled:!1},{value:"Y",enabled:!1},{value:"Z",enabled:!1}],e.game={user:a.user,gameOptions:{themes:[],availableLetters:s(),rounds:"4",numberOfPlayers:"6",roundTime:"30"}},e.addTheme=(t=>{o.includes(t)||o.push(t),e.game.gameOptions.themes.includes(t)}),e.rebuildSelectedLetters=function(){e.game.gameOptions.availableLetters=s()},e.confirm=function(){e.game.gameOptions.availableLetters=s(),n.post(r.uri+"/api/games.create",e.game).then(e=>{t.path("/game/"+e.data.id)})},e.goToLobby=(()=>{t.path("/lobby")})}]),angular.module("WeStop").controller("createUserController",["$scope","uuid","$user","$location","facebookService","googleService","twitterService",function(e,t,a,n,r,o,i){function s(e,r){a.create({id:t.v4(),userName:e,imageUri:r}),n.path("/lobby")}e.user={name:"",image:"/images/default-user.jpg"},e.createUser=(()=>{s(e.user.name,e.user.image)}),e.createWithFacebook=(()=>{r.connect().then(function(t){r.me("first_name").then(function(t){e.user.name=t.first_name,r.getProfilePic(t.id).then(function(t){e.user.image=t,s(e.user.name,e.user.image)})},function(e){console.log(e)})})}),e.createWithGoogle=(()=>{o.getUserNameAndProfilePic().then(e=>{s(e.userName,e.imageUri)},function(e){console.log(e)})}),e.createWithTwitter=(()=>{i.getUserNameAndProfilePic().then(function(e){s(e.userName,e.imageUri)},function(e){console.log(e)})})}]),angular.module("WeStop").controller("gameController",["$routeParams","$scope","$hub","$rootScope","$toast","$location","$mdDialog",function(e,t,a,n,r,o,i){let s=a.createConnection("/game");function l(){t.allPlayersReady=!1,t.roundStarted=!1,t.roundStopped=!1,t.gameFinished=!1,t.validationStarted=!1,t.validationTimeOver=!1,t.sortedLetter="?",t.answersTime=0,t.currentAnswersTimePercentage=0,t.currentValidationTime=0,t.currentValidationTimePercentage=0,t.themeValidations=null}function u(){t.allPlayersReady=!0,t.roundStarted=!0,t.roundStopped=!1,t.gameFinished=!1,t.validationStarted=!1,t.validationTimeOver=!1,t.answers=[];for(let e=0;e<t.game.themes.length;e++)t.answers.push({theme:t.game.themes[e],answer:""})}function d(e){let a=t.scoreboard.find(t=>t.playerId===e);return a?a.gamePontuation:0}function c(){1!==t.game.players.length?t.allPlayersReady=!t.game.players.some(e=>e.id!==t.player.id&&!e.isReady):t.allPlayersReady=!1}function m(){t.currentValidation=null}function g(){for(let e=0;e<t.game.players.length;e++){let a=t.game.players[e];a.totalPontuation=d(a.id)}}function p(e){t.sortedLetter=e}function f(e){t.scoreboard=e}function h(e){return t.game.players.find(t=>t.id===e)}function v(){t.game.currentRoundNumber+=1}function b(e,t){return 100*t/e}function y(){return{gameId:e.id,playerId:n.user.id,roundNumber:t.game.currentRoundNumber,theme:t.currentValidation.theme,validations:t.currentValidation.validations}}function S(e){return t.game.players.indexOf(e)}a.on(s,"im_joined_game",e=>{!function(e){t.game=e,t.game.players.sort(function(e,t){return e.id==n.user.id?-1:t.id==n.user.id?1:0})}(e.game),function(e){t.player=e}(e.player),f(e.lastRoundScoreboard),c(),"InProgress"===e.game.state?(p(e.round.sortedLetter),u()):v()}),t.startRound=(()=>{t.changeStatus(),a.invoke(s,"start_round",e.id)}),a.on(s,"round_started",e=>{p(e.sortedLetter);let a=t.game.availableLetters.indexOf(e.sortedLetter);t.game.availableLetters.splice(a,1),t.game.sortedLetters.push(e.sortedLetter),u()}),a.on(s,"player_joined_game",e=>{t.game.players.find(t=>t.id===e.player.id)||(t.game.players.push(e.player),r.show(e.player.userName+" entrou na partida")),c()}),a.on(s,"game_join_error",e=>{switch(e){case"GAME_NOT_FOUND":r.show("Essa partida não existe mais");break;case"GAME_FULL":r.show("Essa partida está cheia");break;case"PLAYER_NOT_AUTHORIZED":r.show("Você não está autorizado para entrar nessa partida")}t.goToLobby()}),t.changeStatus=(()=>{a.invoke(s,"player_change_status",e.id,n.user.id,!t.player.isReady)}),a.on(s,"im_change_status",e=>{let a=h(t.player.id);t.player.isReady=a.isReady=e.isReady}),a.on(s,"player_changed_status",e=>{h(e.id).isReady=e.isReady,c()}),t.stop=(()=>{a.invoke(s,"stop_round",e.id,n.user.id)}),a.on(s,"round_stoped",o=>{if("player_call_stop"===o.reason&&o.playerId!==t.player.id){let e=h(o.playerId);r.show(e.userName+" chamou STOP!")}t.roundStopped=!0,t.roundTime=0,a.invoke(s,"send_answers",{playerId:n.user.id,gameId:e.id,roundNumber:t.game.currentRoundNumber,answers:t.answers})}),a.on(s,"im_send_validations",e=>{m()}),a.on(s,"round_finished",e=>{l(),f(e.scoreboard),g(),v(),m(),t.changeStatus()}),a.on(s,"game_finished",e=>{l(),t.allPlayersReady=!1,t.roundStarted=!1,t.roundStopped=!1,t.gameFinished=!0,t.validationStarted=!1,t.validationTimeOver=!0,f(e.lastRoundScoreboard),function(e){t.winners=e}(e.winners),g()}),t.roundPontuations=[],a.on(s,"receive_my_pontuations_in_round",e=>{t.roundPontuations.push(e)}),a.on(s,"round_time_elapsed",e=>{t.currentAnswersTimePercentage=b(t.game.time,e),function(e){t.currentAnswersTime=e}(e)}),a.on(s,"validation_started",e=>{!function(e){e.validations&&0!==e.validations.length&&(t.currentValidationTimePercentage=0,t.currentValidation={number:e.validationsNumber,total:e.totalValidations,theme:e.theme,validations:e.validations})}(e),t.allPlayersReady=!0,t.roundStarted=!0,t.roundStopped=!0,t.gameFinished=!1,t.validationStarted=!0,t.validationTimeOver=!1,t.currentValidationTime=0}),a.on(s,"validation_time_elapsed",e=>{t.currentValidationTimePercentage=b(10,e.currentTime),function(e){t.currentValidationTime=e}(e.currentTime)}),a.on(s,"validation_time_over",()=>{t.validationTimeOver=!0,function(){let e=y();a.invoke(s,"send_validations_after_time_over",e)}()}),t.finishValidation=function(){let e=y();a.invoke(s,"send_validations",e)},a.on(s,"player_left",e=>{let a=h(e);a&&(!function(e){let a=S(e);a>-1&&t.game.players.splice(a,1)}(a),a.id!==t.player.id&&(r.show(a.userName+" deixou a partida"),t.game.numberOfPlayers--))}),a.on(s,"new_admin_setted",e=>{!function(e){let a=S(e);a>-1&&(t.game.players[a].isAdmin=!0,e.id===t.player.id&&(t.player.isAdmin=!0,r.show("Você é o administrador da partida")))}(h(e))}),t.leave=(()=>{let r=i.confirm().title("Confirmação").textContent("Tem certeza que quer sair da partida?").ok("Sim").cancel("Não");i.show(r).then(function(){t.gameFinished?t.goToLobby():(n.isLoading=!0,a.invoke(s,"leave",e.id,n.user.id).then(function(){n.isLoading=!1,t.goToLobby()},()=>n.isLoading=!1))},function(){})}),a.on(s,"im_left",()=>t.goToLobby()),t.goToLobby=(()=>{a.stop(s),o.path("/lobby")}),l(),a.connect(s,()=>{a.invoke(s,"join",e.id,n.user)})}]),angular.module("WeStop").controller("lobbyController",["$scope","$location","$http","API_SETTINGS","$mdDialog","$rootScope","$toast","$hub",function(e,t,a,n,r,o,i,s){function l(t){a.post(n.uri+"/api/games.authorize?gameid="+e.gameDetails.id+"&password="+t,o.user).then(t=>{if(t.data.ok)e.joinGame();else switch(t.data.error){case"INCORRECT_PASSWORD":i.show("Senha incorreta");break;case"GAME_NOT_FOUND":i.show("Essa partida não existe mais")}},()=>{})}a.get(n.uri+"/api/games.list").then(t=>{e.games=t.data.games},e=>{console.error(e)}),e.gameDetails=null,e.showGameDetails=!1,e.details=function(t){e.gameDetails=t,e.showGameDetails=!0},e.backToGames=function(){e.gameDetails=null,e.showGameDetails=!1},e.checkGame=(()=>{e.gameDetails.isPrivate?r.show({templateUrl:"./views/game-password.html",escapeToClose:!0,preserveScope:!0,controller:["$scope",function(e){e.password="",e.confirm=(e=>{r.hide(e)}),e.cancel=(()=>{r.cancel()})}]}).then(function(e){l(e)},()=>{}):l("")}),e.joinGame=(()=>t.path("/game/"+e.gameDetails.id)),e.newGame=(()=>t.path("/game/create"));let u=s.createConnection("/lobby");function d(t){return e.games.find(e=>e.id==t)}s.on(u,"game_created",t=>{e.games.push(t)}),s.on(u,"player_joined_game",e=>{d(e).numberOfPlayers++}),s.on(u,"round_started",e=>{d(e).currentRoundNumber++}),s.on(u,"player_left_game",e=>{d(e).numberOfPlayers--}),s.on(u,"game_finished",t=>{let a=d(t),n=e.games.indexOf(a);e.games.splice(n,1)}),s.connect(u)}]),angular.module("WeStop").controller("mainController",["$scope","$location","$user","$mdTheming",function(e,t,a,n){const r="themePreference";function o(){localStorage.setItem(r,e.selectedTheme)}e.preferences={isDarkModeSelected:!1},e.logout=function(){a.logout(()=>t.path("/"))},e.changeTheme=function(){e.preferences.isDarkModeSelected?e.selectedTheme="dark":e.selectedTheme="light",o()},function(){let t=localStorage.getItem(r);t&&""!==t?e.selectedTheme=t:(e.selectedTheme=n.defaultTheme(),o()),"dark"===e.selectedTheme&&(e.preferences.isDarkModeSelected=!0)}()}]),angular.module("WeStop").factory("httpInterceptor",["$rootScope","$q",function(e,t){var a=0;return{request:function(t){return e.isLoading=!0,a++,t},requestError:function(n){return--a<=0&&(e.isLoading=!1),t.reject(n)},response:function(t){return--a<=0&&(e.isLoading=!1),t},responseError:function(n){return--a<=0&&(e.isLoading=!1),t.reject(n)}}}]),angular.module("WeStop").factory("facebookService",["$q",function(e){return{connect:function(){var t=e.defer();return FB.getLoginStatus(function(e){"connected"!==e.status?FB.login(function(e){"connected"===e.status?t.resolve(e):t.reject(e)},{scope:"public_profile"}):t.resolve(e)}),t.promise},me:function(t){var a=e.defer();return FB.api("/me",{fields:t},function(e){!e||e.error?a.reject("Error occured"):a.resolve(e)}),a.promise},getProfilePic:function(t){var a=e.defer();return FB.api(t+"/picture?redirect=false&height=200&width=200",function(e){a.resolve(e.data.url)}),a.promise}}}]),angular.module("WeStop").factory("googleService",["$q","$window",function(e,t){function a(e){let t=e.getBasicProfile();return{userName:t.getGivenName(),imageUri:t.getImageUrl()}}return{getUserNameAndProfilePic:function(){let t=e.defer();return gapi.load("auth2",function(){gapi.auth2.init({client_id:"418166283498-phlpf67p4nitc1gd79s51afl3ruqls2d.apps.googleusercontent.com",fetch_basic_profile:!0}).then(function(e){let n=e.currentUser.get();if(n&&n.isSignedIn()){let e=a(n);t.resolve(e)}else e.signIn({prompt:"select_account"}).then(function(e){let n=a(e);t.resolve(n)},function(e){t.reject(e)})})}),t.promise}}}]),angular.module("WeStop").factory("$hub",["$rootScope","API_SETTINGS",function(e,t){return{createConnection:function(e){return(new signalR.HubConnectionBuilder).withUrl(t.uri+e).build()},on:function(t,a,n){t.on(a,t=>{e.$apply(()=>{n&&n(t)})})},invoke:function(e,...t){return e.invoke(...t)},connect:function(t,a,n){t.serverTimeoutInMilliseconds=3e4,t.onclose(function(){onConnectionClose()}),t.start().then(function(){e.$apply(()=>{a&&a()})},t=>{e.$apply(function(){n&&n(t)})})},stop:function(e){e&&(e.connection.stop(),e=null)}}}]),angular.module("WeStop").factory("$toast",["$mdToast",function(e){return{show:function(t){e.show(e.simple().textContent(t).position("bottom left").hideDelay(3500))}}}]),angular.module("WeStop").factory("twitterService",["$q",function(e){const t={apiKey:"AIzaSyAMtxk9YGof82udlAC_LkkB4mgc-JxFmAI",authDomain:"westop-1571110414274.firebaseapp.com",databaseURL:"https://westop-1571110414274.firebaseio.com",projectId:"westop-1571110414274",storageBucket:"westop-1571110414274.appspot.com",messagingSenderId:"418166283498",appId:"1:418166283498:web:7ab90ab027f742f6b80b93"};return{getUserNameAndProfilePic:function(){firebase.apps.length||firebase.initializeApp(t);let a=new firebase.auth.TwitterAuthProvider,n=e.defer();return firebase.auth().signInWithPopup(a).then(function(e){let t=e.user;n.resolve({userName:t.displayName.split(" ")[0],imageUri:t.photoURL})}).catch(function(e){n.reject(e)}),n.promise}}}]),angular.module("WeStop").service("$user",["$rootScope",function(e){this.create=(t=>{sessionStorage.setItem("user",JSON.stringify(t)),e.user=t}),this.get=(()=>JSON.parse(sessionStorage.getItem("user"))),this.logout=(t=>{sessionStorage.removeItem("user"),e.user=null,t&&t()})}]);