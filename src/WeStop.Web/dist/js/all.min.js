...
angular.module("WeStop",["ngRoute","ngMessages","ngAnimate","angular-uuid","ngMaterial","md.data.table"]).value("API_SETTINGS",{uri:"https://westopapi.azurewebsites.net"}).config(["$routeProvider","$locationProvider","$mdThemingProvider","$httpProvider","$mdGestureProvider","$mdAriaProvider",function(e,t,n,a,o,r){a.interceptors.push("httpInterceptor"),t.hashPrefix(""),o.skipClickHijack(),n.alwaysWatchTheme(!0),n.theme("light").primaryPalette("blue").accentPalette("teal").warnPalette("red").backgroundPalette("grey"),n.theme("dark").dark(),n.theme("dark").primaryPalette("blue").accentPalette("teal").warnPalette("red").dark(),n.setDefaultTheme("dark"),r.disableWarnings(),e.when("/",{controller:"createUserController",templateUrl:"views/user/create.html",secure:!1}).when("/lobby",{controller:"lobbyController",templateUrl:"views/lobby.html",secure:!0}).when("/game/create",{controller:"createGameController",templateUrl:"views/game/create.html",secure:!0}).when("/game/:id",{controller:"gameController",templateUrl:"views/game/game.html",secure:!0}).otherwise({redirectTo:"/"})}]).run(["$user","$rootScope","$location","$window","$hub",(e,t,n,a,o)=>{t.user=e.get(),t.$on("$routeChangeStart",(e,a,r)=>{o.stopAllHubConnections(),a.$$route.secure&&!t.user?n.path("/"):!a.$$route.secure&&t.user&&n.path("/lobby")}),a.fbAsyncInit=function(){FB.init({appId:"659220371267596",status:!0,cookie:!0,xfbml:!0,version:"v2.6"})},"serviceWorker"in navigator&&navigator.serviceWorker.register("./service-worker.js").then(function(e){},function(e){console.log("ServiceWorker registration failed: ",e)})}]),angular.module("WeStop").controller("createGameController",["$scope","$location","$rootScope","$http","API_SETTINGS",function(e,t,n,a,o){let r=[];function i(t){e.game.gameOptions.themes=[];for(let n=0;n<t;n++){let t=r.filter(t=>!e.game.gameOptions.themes.includes(t)),n=t[Math.floor(Math.random()*t.length)];e.game.gameOptions.themes.push(n)}}function l(){let t=[];return e.letters.forEach(e=>{e.enabled&&t.push(e.value)}),t}a.get(o.uri+"/api/themes.list").then(e=>{e.data.themes.forEach(e=>{r.push(e.name)}),i(6)}),e.drawnAnotherThemes=function(){i(6)},e.themeToAdd={},e.letters=[{value:"A",enabled:!0},{value:"B",enabled:!0},{value:"C",enabled:!0},{value:"D",enabled:!0},{value:"E",enabled:!0},{value:"F",enabled:!0},{value:"G",enabled:!0},{value:"H",enabled:!1},{value:"I",enabled:!0},{value:"J",enabled:!0},{value:"K",enabled:!1},{value:"L",enabled:!0},{value:"M",enabled:!0},{value:"N",enabled:!0},{value:"O",enabled:!0},{value:"P",enabled:!0},{value:"Q",enabled:!1},{value:"R",enabled:!0},{value:"S",enabled:!0},{value:"T",enabled:!0},{value:"U",enabled:!1},{value:"V",enabled:!0},{value:"W",enabled:!1},{value:"X",enabled:!1},{value:"Y",enabled:!1},{value:"Z",enabled:!1}],e.game={user:n.user,gameOptions:{themes:[],availableLetters:l(),rounds:"4",numberOfPlayers:"6",roundTime:"30"}},e.addTheme=(t=>{r.includes(t)||r.push(t),e.game.gameOptions.themes.includes(t)}),e.rebuildSelectedLetters=function(){e.game.gameOptions.availableLetters=l()},e.confirm=function(){e.game.gameOptions.availableLetters=l(),a.post(o.uri+"/api/games.create",e.game).then(e=>{t.path("/game/"+e.data.id)})},e.goToLobby=(()=>{t.path("/lobby")})}]),angular.module("WeStop").controller("createUserController",["$scope","uuid","$user","$location","facebookService","googleService","twitterService",function(e,t,n,a,o,r,i){function l(e,o){n.create({id:t.v4(),userName:e,imageUri:o}),a.path("/lobby")}e.user={name:"",image:"/images/default-user.jpg"},e.createUser=(()=>{l(e.user.name,e.user.image)}),e.createWithFacebook=(()=>{o.connect().then(function(t){o.me("first_name").then(function(t){e.user.name=t.first_name,o.getProfilePic(t.id).then(function(t){e.user.image=t,l(e.user.name,e.user.image)})},function(e){console.log(e)})})}),e.createWithGoogle=(()=>{r.getUserNameAndProfilePic().then(e=>{l(e.userName,e.imageUri)},function(e){console.log(e)})}),e.createWithTwitter=(()=>{i.getUserNameAndProfilePic().then(function(e){l(e.userName,e.imageUri)},function(e){console.log(e)})})}]),angular.module("WeStop").controller("gameController",["$routeParams","$scope","$hub","$rootScope","$toast","$location","$mdDialog",function(e,t,n,a,o,r,i){let l=n.createConnection("/game");function s(){t.allPlayersReady=!1,t.roundStarted=!1,t.roundStopped=!1,t.gameFinished=!1,t.validationStarted=!1,t.validationTimeOver=!1,t.sortedLetter="?",t.answersTime=0,t.currentAnswersTimePercentage=0,t.currentValidationTime=0,t.currentValidationTimePercentage=0,t.themeValidations=null}function u(){t.allPlayersReady=!0,t.roundStarted=!0,t.roundStopped=!1,t.gameFinished=!1,t.validationStarted=!1,t.validationTimeOver=!1,t.answers=[];for(let e=0;e<t.game.themes.length;e++)t.answers.push({theme:t.game.themes[e],answer:""})}function c(e){let n=t.scoreboard.find(t=>t.playerId===e);return n?n.gamePontuation:0}function d(){1!==t.game.players.length?t.allPlayersReady=!t.game.players.some(e=>e.id!==t.player.id&&!e.isReady):t.allPlayersReady=!1}function m(){t.currentValidation=null}function p(){for(let e=0;e<t.game.players.length;e++){let n=t.game.players[e];n.totalPontuation=c(n.id)}}function g(e){t.sortedLetter=e}function f(e){t.scoreboard=e}function h(e){return t.game.players.find(t=>t.id===e)}function b(){t.game.currentRoundNumber+=1}function v(e,t){return 100*t/e}function y(){return{gameId:e.id,playerId:a.user.id,roundNumber:t.game.currentRoundNumber,theme:t.currentValidation.theme,validations:t.currentValidation.validations}}function S(e){return t.game.players.indexOf(e)}n.on(l,"im_joined_game",e=>{!function(e){t.game=e,t.game.players.sort(function(e,t){return e.id==a.user.id?-1:t.id==a.user.id?1:0})}(e.game),function(e){t.player=e}(e.player),f(e.lastRoundScoreboard),d(),"InProgress"===e.game.state?(g(e.round.sortedLetter),u()):b()}),t.startRound=(()=>{t.changeStatus(),n.invoke(l,"start_round",e.id)}),n.on(l,"round_started",e=>{g(e.sortedLetter);let n=t.game.availableLetters.indexOf(e.sortedLetter);t.game.availableLetters.splice(n,1),t.game.sortedLetters.push(e.sortedLetter),u()}),n.on(l,"player_joined_game",e=>{t.game.players.find(t=>t.id===e.player.id)||(t.game.players.push(e.player),o.show(e.player.userName+" entrou na partida")),d()}),n.on(l,"game_join_error",e=>{switch(e){case"GAME_NOT_FOUND":o.show("Essa partida não existe mais");break;case"GAME_FULL":o.show("Essa partida está cheia");break;case"PLAYER_NOT_AUTHORIZED":o.show("Você não está autorizado para entrar nessa partida")}t.goToLobby()}),t.changeStatus=(()=>{n.invoke(l,"player_change_status",e.id,a.user.id,!t.player.isReady)}),n.on(l,"im_change_status",e=>{let n=h(t.player.id);t.player.isReady=n.isReady=e.isReady}),n.on(l,"player_changed_status",e=>{h(e.id).isReady=e.isReady,d()}),t.stop=(()=>{n.invoke(l,"stop_round",e.id,a.user.id)}),n.on(l,"round_stoped",r=>{if("player_call_stop"===r.reason&&r.playerId!==t.player.id){let e=h(r.playerId);o.show(e.userName+" chamou STOP!")}t.roundStopped=!0,t.roundTime=0,n.invoke(l,"send_answers",{playerId:a.user.id,gameId:e.id,roundNumber:t.game.currentRoundNumber,answers:t.answers})}),n.on(l,"im_send_validations",e=>{m()}),n.on(l,"round_finished",e=>{s(),f(e.scoreboard),p(),b(),m(),t.changeStatus()}),n.on(l,"game_finished",e=>{s(),t.allPlayersReady=!1,t.roundStarted=!1,t.roundStopped=!1,t.gameFinished=!0,t.validationStarted=!1,t.validationTimeOver=!0,f(e.lastRoundScoreboard),function(e){t.winners=e}(e.winners),p()}),t.roundPontuations=[],n.on(l,"receive_my_pontuations_in_round",e=>{t.roundPontuations.push(e)}),n.on(l,"round_time_elapsed",e=>{t.currentAnswersTimePercentage=v(t.game.time,e),function(e){t.currentAnswersTime=e}(e)}),n.on(l,"validation_started",e=>{!function(e){e.validations&&0!==e.validations.length&&(t.currentValidationTimePercentage=0,t.currentValidation={number:e.validationsNumber,total:e.totalValidations,theme:e.theme,validations:e.validations})}(e),t.allPlayersReady=!0,t.roundStarted=!0,t.roundStopped=!0,t.gameFinished=!1,t.validationStarted=!0,t.validationTimeOver=!1,t.currentValidationTime=0}),n.on(l,"validation_time_elapsed",e=>{t.currentValidationTimePercentage=v(10,e.currentTime),function(e){t.currentValidationTime=e}(e.currentTime)}),n.on(l,"validation_time_over",()=>{t.validationTimeOver=!0,function(){let e=y();n.invoke(l,"send_validations_after_time_over",e)}()}),t.finishValidation=function(){let e=y();n.invoke(l,"send_validations",e)},n.on(l,"player_left",e=>{let n=h(e);n&&(!function(e){let n=S(e);n>-1&&t.game.players.splice(n,1)}(n),n.id!==t.player.id&&(o.show(n.userName+" deixou a partida"),t.game.numberOfPlayers--))}),n.on(l,"new_admin_setted",e=>{!function(e){let n=S(e);n>-1&&(t.game.players[n].isAdmin=!0,e.id===t.player.id&&(t.player.isAdmin=!0,o.show("Você é o administrador da partida")))}(h(e))}),t.leave=(()=>{let o=i.confirm().title("Confirmação").textContent("Tem certeza que quer sair da partida?").ok("Sim").cancel("Não");i.show(o).then(function(){t.gameFinished?t.goToLobby():(a.isLoading=!0,n.invoke(l,"leave",e.id,a.user.id).then(function(){a.isLoading=!1,t.goToLobby()},()=>a.isLoading=!1))},function(){})}),n.on(l,"im_left",()=>t.goToLobby()),t.goToLobby=(()=>{n.stop(l),r.path("/lobby")}),s(),n.connect(l,()=>{n.invoke(l,"join",e.id,a.user)})}]),angular.module("WeStop").controller("lobbyController",["$scope","$location","$http","API_SETTINGS","$mdDialog","$rootScope","$toast","$hub",function(e,t,n,a,o,r,i,l){function s(t){n.post(a.uri+"/api/games.authorize?gameid="+e.gameDetails.id+"&password="+t,r.user).then(t=>{if(t.data.ok)e.joinGame();else switch(t.data.error){case"INCORRECT_PASSWORD":i.show("Senha incorreta");break;case"GAME_NOT_FOUND":i.show("Essa partida não existe mais")}},()=>{})}n.get(a.uri+"/api/games.list").then(t=>{e.games=t.data.games},e=>{console.error(e)}),e.gameDetails=null,e.showGameDetails=!1,e.details=function(t){e.gameDetails=t,e.showGameDetails=!0},e.backToGames=function(){e.gameDetails=null,e.showGameDetails=!1},e.checkGame=(()=>{e.gameDetails.isPrivate?o.show({templateUrl:"./views/game-password.html",escapeToClose:!0,preserveScope:!0,controller:["$scope",function(e){e.password="",e.confirm=(e=>{o.hide(e)}),e.cancel=(()=>{o.cancel()})}]}).then(function(e){s(e)},()=>{}):s("")}),e.joinGame=(()=>t.path("/game/"+e.gameDetails.id)),e.newGame=(()=>t.path("/game/create"));let u=l.createConnection("/lobby");function c(t){return e.games.find(e=>e.id==t)}l.on(u,"game_created",t=>{e.games.push(t)}),l.on(u,"player_joined_game",e=>{c(e).numberOfPlayers++}),l.on(u,"round_started",e=>{c(e).currentRoundNumber++}),l.on(u,"player_left_game",e=>{c(e).numberOfPlayers--}),l.on(u,"game_finished",t=>{let n=c(t),a=e.games.indexOf(n);e.games.splice(a,1)}),l.connect(u)}]),angular.module("WeStop").controller("mainController",["$scope","$location","$user","$mdTheming",function(e,t,n,a){const o="themePreference";function r(){localStorage.setItem(o,e.selectedTheme)}e.preferences={isDarkModeSelected:!1},e.logout=function(){n.logout(()=>t.path("/"))},e.changeTheme=function(){e.preferences.isDarkModeSelected?e.selectedTheme="dark":e.selectedTheme="light",r()},function(){let t=localStorage.getItem(o);t&&""!==t?e.selectedTheme=t:(e.selectedTheme=a.defaultTheme(),r()),"dark"===e.selectedTheme&&(e.preferences.isDarkModeSelected=!0)}()}]),angular.module("WeStop").factory("httpInterceptor",["$rootScope","$q",function(e,t){var n=0;return{request:function(t){return e.isLoading=!0,n++,t},requestError:function(a){return--n<=0&&(e.isLoading=!1),t.reject(a)},response:function(t){return--n<=0&&(e.isLoading=!1),t},responseError:function(a){return--n<=0&&(e.isLoading=!1),t.reject(a)}}}]),angular.module("WeStop").factory("facebookService",["$q",function(e){return{connect:function(){var t=e.defer();return FB.getLoginStatus(function(e){"connected"!==e.status?FB.login(function(e){"connected"===e.status?t.resolve(e):t.reject(e)},{scope:"public_profile"}):t.resolve(e)}),t.promise},me:function(t){var n=e.defer();return FB.api("/me",{fields:t},function(e){!e||e.error?n.reject("Error occured"):n.resolve(e)}),n.promise},getProfilePic:function(t){var n=e.defer();return FB.api(t+"/picture?redirect=false&height=200&width=200",function(e){n.resolve(e.data.url)}),n.promise}}}]),angular.module("WeStop").factory("googleService",["$q","$window",function(e,t){function n(e){let t=e.getBasicProfile();return{userName:t.getGivenName(),imageUri:t.getImageUrl()}}return{getUserNameAndProfilePic:function(){let t=e.defer();return gapi.load("auth2",function(){gapi.auth2.init({client_id:"418166283498-phlpf67p4nitc1gd79s51afl3ruqls2d.apps.googleusercontent.com",fetch_basic_profile:!0}).then(function(e){let a=e.currentUser.get();if(a&&a.isSignedIn()){let e=n(a);t.resolve(e)}else e.signIn({prompt:"select_account"}).then(function(e){let a=n(e);t.resolve(a)},function(e){t.reject(e)})})}),t.promise}}}]),angular.module("WeStop").factory("$hub",["$rootScope","API_SETTINGS",function(e,t){let n=[];return{createConnection:function(e){let a=(new signalR.HubConnectionBuilder).withUrl(t.uri+e).build();return n.push(a),a},on:function(t,n,a){t.on(n,t=>{e.$apply(()=>{a&&a(t)})})},invoke:function(e,...t){return e.invoke(...t)},connect:function(t,n,a){t.serverTimeoutInMilliseconds=3e4,t.onclose(function(){onConnectionClose()}),t.start().then(function(){e.$apply(()=>{n&&n()})},t=>{e.$apply(function(){a&&a(t)})})},stop:function(e){e&&(e.connection.stop(),e=null)},stopAllHubConnections:function(){for(let e=0;e<n.length;e++)hubConnection=n[e],"Connected"===hubConnection.connectionState&&hubConnection.connection.stop();n=[]}}}]),angular.module("WeStop").factory("$toast",["$mdToast",function(e){return{show:function(t){e.show(e.simple().textContent(t).position("bottom left").hideDelay(3500))}}}]),angular.module("WeStop").factory("twitterService",["$q",function(e){const t={apiKey:"AIzaSyAMtxk9YGof82udlAC_LkkB4mgc-JxFmAI",authDomain:"westop-1571110414274.firebaseapp.com",databaseURL:"https://westop-1571110414274.firebaseio.com",projectId:"westop-1571110414274",storageBucket:"westop-1571110414274.appspot.com",messagingSenderId:"418166283498",appId:"1:418166283498:web:7ab90ab027f742f6b80b93"};return{getUserNameAndProfilePic:function(){firebase.apps.length||firebase.initializeApp(t);let n=new firebase.auth.TwitterAuthProvider,a=e.defer();return firebase.auth().signInWithPopup(n).then(function(e){let t=e.user;a.resolve({userName:t.displayName.split(" ")[0],imageUri:t.photoURL})}).catch(function(e){a.reject(e)}),a.promise}}}]),angular.module("WeStop").service("$user",["$rootScope",function(e){this.create=(t=>{sessionStorage.setItem("user",JSON.stringify(t)),e.user=t}),this.get=(()=>JSON.parse(sessionStorage.getItem("user"))),this.logout=(t=>{sessionStorage.removeItem("user"),e.user=null,t&&t()})}]);