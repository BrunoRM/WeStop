...
angular.module("WeStop",["ngRoute","ngMessages","ngAnimate","angular-uuid","ngMaterial","md.data.table"]).value("API_SETTINGS",{uri:"https://westopapi.azurewebsites.net"}).config(["$routeProvider","$locationProvider","$mdThemingProvider","$httpProvider","$mdGestureProvider","$mdAriaProvider",function(e,t,n,a,r,o){a.interceptors.push("httpInterceptor"),t.hashPrefix(""),r.skipClickHijack(),n.theme("default").dark(),n.theme("default").primaryPalette("blue").accentPalette("teal").warnPalette("red"),o.disableWarnings(),e.when("/",{controller:"createUserController",templateUrl:"views/user/create.html",secure:!1}).when("/lobby",{controller:"lobbyController",templateUrl:"views/lobby.html",secure:!0}).when("/game/create",{controller:"createGameController",templateUrl:"views/game/create.html",secure:!0}).when("/game/:id",{controller:"gameController",templateUrl:"views/game/game.html",secure:!0}).otherwise({redirectTo:"/"})}]).run(["$user","$rootScope","$location","$window",(e,t,n,a)=>{t.user=e.get(),t.$on("$routeChangeStart",(e,a,r)=>{a.$$route.secure&&!t.user?n.path("/"):!a.$$route.secure&&t.user&&n.path("/lobby")}),a.fbAsyncInit=function(){FB.init({appId:"659220371267596",status:!0,cookie:!0,xfbml:!0,version:"v2.6"})},"serviceWorker"in navigator&&navigator.serviceWorker.register("./service-worker.js").then(function(e){},function(e){console.log("ServiceWorker registration failed: ",e)})}]),angular.module("WeStop").controller("createGameController",["$game","$scope","$location","$rootScope","$http","API_SETTINGS",function(e,t,n,a,r,o){let i=[];function l(e){t.game.gameOptions.themes=[];for(let n=0;n<e;n++){let e=i.filter(e=>!t.game.gameOptions.themes.includes(e)),n=e[Math.floor(Math.random()*e.length)];t.game.gameOptions.themes.push(n)}}r.get(o.uri+"/api/themes.list").then(e=>{e.data.themes.forEach(e=>{i.push(e.name)}),l(6)}),t.drawnAnotherThemes=function(){l(6)},t.themeToAdd={},t.letters=[{value:"A",enabled:!0},{value:"B",enabled:!0},{value:"C",enabled:!0},{value:"D",enabled:!0},{value:"E",enabled:!0},{value:"F",enabled:!0},{value:"G",enabled:!0},{value:"H",enabled:!1},{value:"I",enabled:!0},{value:"J",enabled:!0},{value:"K",enabled:!1},{value:"L",enabled:!0},{value:"M",enabled:!0},{value:"N",enabled:!0},{value:"O",enabled:!0},{value:"P",enabled:!0},{value:"Q",enabled:!1},{value:"R",enabled:!0},{value:"S",enabled:!0},{value:"T",enabled:!0},{value:"U",enabled:!1},{value:"V",enabled:!0},{value:"W",enabled:!1},{value:"X",enabled:!1},{value:"Y",enabled:!1},{value:"Z",enabled:!1}],t.game={user:a.user,gameOptions:{themes:[],availableLetters:[],rounds:"4",numberOfPlayers:"6",roundTime:"30"}},t.addTheme=(e=>{i.includes(e)||i.push(e),t.game.gameOptions.availableThemes.includes(e)}),t.confirm=function(){t.game.gameOptions.availableLetters=function(){let e=[];return t.letters.forEach(t=>{t.enabled&&e.push(t.value)}),e}(),r.post(o.uri+"/api/games.create",t.game).then(e=>{n.path("/game/"+e.data.id)})},t.goToLobby=(()=>{n.path("/lobby")})}]),angular.module("WeStop").controller("createUserController",["$scope","uuid","$user","$location","facebookService","googleService","twitterService",function(e,t,n,a,r,o,i){function l(e,r){n.create({id:t.v4(),userName:e,imageUri:r}),a.path("/lobby")}e.user={name:"",image:"/images/default-user.jpg"},e.createUser=(()=>{l(e.user.name,e.user.image)}),e.createWithFacebook=(()=>{r.connect().then(function(t){r.me("first_name").then(function(t){e.user.name=t.first_name,r.getProfilePic(t.id).then(function(t){e.user.image=t,l(e.user.name,e.user.image)})},function(e){console.log(e)})})}),e.createWithGoogle=(()=>{o.getUserNameAndProfilePic().then(e=>{l(e.userName,e.imageUri)},function(e){console.log(e)})}),e.createWithTwitter=(()=>{i.getUserNameAndProfilePic().then(function(e){l(e.userName,e.imageUri)},function(e){console.log(e)})})}]),angular.module("WeStop").controller("gameController",["$routeParams","$scope","$game","$rootScope","$mdToast",function(e,t,n,a,r){function o(){t.allPlayersReady=!1,t.roundStarted=!1,t.roundStopped=!1,t.gameFinished=!1,t.validationStarted=!1,t.validationTimeOver=!1,t.sortedLetter="?",t.answersTime=0,t.currentAnswersTimePercentage=0,t.currentValidationTime=0,t.currentValidationTimePercentage=0,t.themeValidations=null}function i(e){t.game=e,t.game.players.sort(function(e,t){return e.id==a.user.id?-1:t.id==a.user.id?1:0})}function l(e){t.player=e}function s(){t.allPlayersReady=!0,t.roundStarted=!0,t.roundStopped=!1,t.gameFinished=!1,t.validationStarted=!1,t.validationTimeOver=!1,t.answers=[];for(let e=0;e<t.game.themes.length;e++)t.answers.push({theme:t.game.themes[e],answer:""})}function u(){t.allPlayersReady=!0,t.roundStarted=!0,t.roundStopped=!0,t.gameFinished=!1,t.validationStarted=!0,t.validationTimeOver=!1,t.currentValidationTime=0}function d(){t.allPlayersReady=!1,t.roundStarted=!1,t.roundStopped=!1,t.gameFinished=!0,t.validationStarted=!1,t.validationTimeOver=!0}function c(e){let n=t.scoreboard.find(t=>t.playerId===e);return n?n.gamePontuation:0}function m(){1!==t.game.players.length?t.allPlayersReady=!t.game.players.some(e=>e.id!==t.player.id&&!e.isReady):t.allPlayersReady=!1}function g(){t.currentValidation=null}function p(){for(let e=0;e<t.game.players.length;e++){let n=t.game.players[e];n.totalPontuation=c(n.id)}}function f(e){t.winners=e}function h(e){t.sortedLetter=e}function v(e){t.scoreboard=e}function b(e){return t.game.players.find(t=>t.id===e)}function y(){t.game.currentRoundNumber+=1}function S(e,t){return 100*t/e}function w(e){e.validations&&0!==e.validations.length&&(t.currentValidationTimePercentage=0,t.currentValidation={number:e.validationsNumber,total:e.totalValidations,theme:e.theme,validations:e.validations})}function $(){return{gameId:e.id,playerId:a.user.id,roundNumber:t.game.currentRoundNumber,theme:t.currentValidation.theme,validations:t.currentValidation.validations}}n.on("im_joined_game",e=>{i(e.game),l(e.player),y(),v(e.lastRoundScoreboard),m()}),n.on("im_reconected_game",e=>{switch(i(e.game),l(e.player),e.game.state){case"InProgress":h(e.round.sortedLetter),s();break;case"Validations":h(e.round.sortedLetter),e.validated?g():(w(e),u());break;case"Finished":f(e.winners),v(e.lastRoundScoreboard),d(),p()}}),t.startRound=(()=>{t.changeStatus(),n.invoke("start_round",e.id)}),n.on("round_started",e=>{h(e.sortedLetter),s()}),n.on("player_joined_game",e=>{t.game.players.find(t=>t.id===e.player.id)||t.game.players.push(e.player),m()}),t.changeStatus=(()=>{n.invoke("player_change_status",e.id,a.user.id,!t.player.isReady)}),n.on("im_change_status",e=>{let n=b(t.player.id);t.player.isReady=n.isReady=e.isReady}),n.on("player_changed_status",e=>{b(e.id).isReady=e.isReady,m()}),t.stop=(()=>{n.invoke("stop_round",e.id,a.user.id)}),n.on("round_stoped",o=>{if("player_call_stop"===o.reason&&o.playerId!==t.player.id){let e=b(o.playerId);r.show(r.simple().textContent(e.userName+" chamou STOP!").position("bottom left").hideDelay(3500))}t.roundStopped=!0,t.roundTime=0,n.invoke("send_answers",{playerId:a.user.id,gameId:e.id,roundNumber:t.game.currentRoundNumber,answers:t.answers})}),n.on("im_send_validations",e=>{g()}),n.on("round_finished",e=>{o(),v(e.scoreboard),p(),y(),g(),t.changeStatus()}),n.on("game_finished",e=>{o(),d(),v(e.lastRoundScoreboard),f(e.winners),p()}),n.on("round_time_elapsed",e=>{t.currentAnswersTimePercentage=S(t.game.time,e),function(e){t.currentAnswersTime=e}(e)}),n.on("validation_started",e=>{w(e),u()}),n.on("validation_time_elapsed",e=>{t.currentValidationTimePercentage=S(10,e.currentTime),function(e){t.currentValidationTime=e}(e.currentTime)}),n.on("validation_time_over",()=>{t.validationTimeOver=!0,function(){let e=$();n.invoke("send_validations_after_time_over",e)}()}),t.finishValidation=function(){let e=$();n.invoke("send_validations",e)},o(),n.invoke("join",e.id,"",a.user)}]),angular.module("WeStop").controller("lobbyController",["$scope","$location","$http","API_SETTINGS",function(e,t,n,a){n.get(a.uri+"/api/games.list").then(t=>{e.games=t.data.games},e=>{console.error(e)}),e.gameDetails=null,e.showGameDetails=!1,e.details=function(t){e.gameDetails=t,e.showGameDetails=!0},e.backToGames=function(){e.gameDetails=null,e.showGameDetails=!1},e.joinGame=(()=>t.path("/game/"+e.gameDetails.id)),e.newGame=(()=>t.path("/game/create"))}]),angular.module("WeStop").controller("mainController",["$scope","$location","$user",function(e,t,n){e.logout=function(){n.logout(()=>t.path("/"))}}]),angular.module("WeStop").factory("httpInterceptor",["$rootScope","$q",function(e,t){var n=0;return{request:function(t){return e.isLoading=!0,n++,t},requestError:function(a){return--n<=0&&(e.isLoading=!1),t.reject(a)},response:function(t){return--n<=0&&(e.isLoading=!1),t},responseError:function(a){return--n<=0&&(e.isLoading=!1),t.reject(a)}}}]),angular.module("WeStop").factory("facebookService",["$q",function(e){return{connect:function(){var t=e.defer();return FB.getLoginStatus(function(e){"connected"!==e.status?FB.login(function(e){"connected"===e.status?t.resolve(e):t.reject(e)},{scope:"public_profile"}):t.resolve(e)}),t.promise},me:function(t){var n=e.defer();return FB.api("/me",{fields:t},function(e){!e||e.error?n.reject("Error occured"):n.resolve(e)}),n.promise},getProfilePic:function(t){var n=e.defer();return FB.api(t+"/picture?redirect=false&height=200&width=200",function(e){n.resolve(e.data.url)}),n.promise}}}]),angular.module("WeStop").factory("$game",["$rootScope","API_SETTINGS",function(e,t){let n=(new signalR.HubConnectionBuilder).withUrl(t.uri+"/game").withAutomaticReconnect().build();function a(){console.log("Connection has closed")}return{onConnectionClose:a,on:function(t,a){n.on(t,t=>{e.$apply(()=>{a&&a(t)})})},invoke:function(...t){var r,o;"Disconnected"===n.state?(r=(()=>n.invoke(...t)),n.serverTimeoutInMilliseconds=3e4,n.onclose(function(){a()}),n.onreconnecting(function(){alert("Client reconectando")}),n.onreconnected(()=>{alert("Client reconectado")}),n.start().then(function(){e.$apply(()=>r())},t=>{e.$apply(function(){o&&o(t)})})):n.invoke(...t)}}}]),angular.module("WeStop").factory("googleService",["$q","$window",function(e,t){function n(e){let t=e.getBasicProfile();return{userName:t.getGivenName(),imageUri:t.getImageUrl()}}return{getUserNameAndProfilePic:function(){let t=e.defer();return gapi.load("auth2",function(){gapi.auth2.init({client_id:"418166283498-phlpf67p4nitc1gd79s51afl3ruqls2d.apps.googleusercontent.com",fetch_basic_profile:!0}).then(function(e){let a=e.currentUser.get();if(a&&a.isSignedIn()){let e=n(a);t.resolve(e)}else e.signIn({prompt:"select_account"}).then(function(e){let a=n(e);t.resolve(a)},function(e){t.reject(e)})})}),t.promise}}}]),angular.module("WeStop").factory("twitterService",["$q",function(e){const t={apiKey:"AIzaSyAMtxk9YGof82udlAC_LkkB4mgc-JxFmAI",authDomain:"westop-1571110414274.firebaseapp.com",databaseURL:"https://westop-1571110414274.firebaseio.com",projectId:"westop-1571110414274",storageBucket:"westop-1571110414274.appspot.com",messagingSenderId:"418166283498",appId:"1:418166283498:web:7ab90ab027f742f6b80b93"};return{getUserNameAndProfilePic:function(){firebase.apps.length||firebase.initializeApp(t);let n=new firebase.auth.TwitterAuthProvider,a=e.defer();return firebase.auth().signInWithPopup(n).then(function(e){let t=e.user;a.resolve({userName:t.displayName.split(" ")[0],imageUri:t.photoURL})}).catch(function(e){a.reject(e)}),a.promise}}}]),angular.module("WeStop").service("$user",["$rootScope",function(e){this.create=(t=>{sessionStorage.setItem("user",JSON.stringify(t)),e.user=t}),this.get=(()=>JSON.parse(sessionStorage.getItem("user"))),this.logout=(t=>{sessionStorage.removeItem("user"),e.user=null,t&&t()})}]);
/*!
